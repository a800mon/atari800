...
extern int MONITOR_breaks_deferred;
#define MONITOR_BreaksDeferred() (MONITOR_breaks_deferred)
...
#define MONITOR_ACTION_STEP_OVER 4
#define MONITOR_ACTION_RUN_RETURN 5
